...
fecha_Dec = datetime.datetime.now().date()
fecha_Actual = fecha_Dec.strftime('%d-%m-%Y')
...
# Cargamos el fichero con los link con error y la fecha que se hizo la validación, formato (D-M-Y)
codesReceived.to_excel(fichero_nombre + "__VALIDADO__" + fecha_Actual + ".xlsx")
